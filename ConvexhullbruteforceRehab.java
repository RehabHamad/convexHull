...
// this code for find convexHull by bruteForce 


package convexhullbruteforcerehab;
...
public class ConvexhullbruteforceRehab {
	...
	private static void ShowGraph() {
		...
		frame.add(new JPanel(){
			...
			public void paintComponent(Graphics g){
                ...
                g.drawString("The points in the Convex hull using Brute Force", 360,568);
    ...
    public static void main(String[] args) {
        ...
        input.close();
       System.out.print("Enter the coordinates of each points: <x> <y>\n");
        PrintList(pointlist);
        
        //BruteForce
        System.out.println("\nThe points in the Convex hull using Brute Force are: ");
